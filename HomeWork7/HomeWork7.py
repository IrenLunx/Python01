...
# Структура: 
# 1. Главный файл "main.py", откуда идет запуск.
# 2. Функционал кнопки с общением с пользователем. "data_users.py"
# 3. Файл, который может получать данные из txt.файла и отправлять в txt.файл. "logger.py"
# C функционалом вывода всех контактов, поиска контакта по имени, добавления и удаления контакта.